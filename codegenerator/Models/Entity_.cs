    ...
    public partial class Entity
    {
        ...
        public List<Entity> RequiredRelationshipEntities
        {
            get
            {
                ...
                var entities = RelationshipsAsChild.Where(r => r.ParentEntityId != EntityId && (r.Hierarchy || !r.UseSelectorDirective)).OrderBy(o => o.SortOrderOnChild).Select(r => r.ParentEntity).ToList();
                entities.AddRange(RelationshipsAsParent.Where(r => r.DisplayListOnParent).OrderBy(o => o.SortOrder).Select(r => r.ChildEntity).ToList());
